...
This project uses **bd (beads)** for issue tracking; run `bd prime` for the full command reference. Universal conventions live in the auto-loaded global rule `~/.claude/rules/bd.md`.
