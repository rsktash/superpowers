...
# Systematic Debugging — budget 1700 words
...
1. **Create Failing Test Case**
   ...
   - Use the `superpowers-beads:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **superpowers-beads:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **superpowers-beads:verification-before-completion** - Verify fix worked before claiming success
