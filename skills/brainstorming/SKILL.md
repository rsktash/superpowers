...
4. **Propose 2-3 surviving approaches** — prune first: a branch excluded by a ruling, code, spec, or a document already read this session is not an approach. Present survivors with trade-offs and your recommendation
...
- Prune first: a branch excluded by a ruling, code, spec, or a document already read this session is not an approach
- Propose 2-3 surviving approaches with trade-offs
